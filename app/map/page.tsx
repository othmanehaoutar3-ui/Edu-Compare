            ...
            <div className="container mx-auto px-4 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                  ...
                  px-4 py-3 rounded-xl outline-none focus:border-cyan-400 transition-all"
                        ...
                        {/* Quick Stats */}
                        <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-400/30 rounded-2xl p-4">
                            ...
                            <div className="absolute bottom-6 left-6 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 z-[1000]">
                                ...
                                <div className="space-y-2 text-xs">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-purple-200">Public (Gratuit)</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <div className="w-3 h-3 bg-blue-500 rounded-full"></div>
                                        <span className="text-purple-200">Privé</span>
                                    </div>
                                </div>
                            </div>
                        </div>
